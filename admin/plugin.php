...
switch ($op) {
    ...
    case "save_plugin":
        ...
        $obj->setVars(array('plugin_name' => Request::getString('plugin_name', '', 'POST'),                   //Form plugin_name
...
//        if (isset($_REQUEST["ok"]) && $_REQUEST["ok"] == 1) {
            ...
            xoops_confirm(array("ok" => 1, "plugin_id" => Request::getInt('plugin_id', 0), "op" => "delete_plugin"), $_SERVER["REQUEST_URI"], sprintf(_AM_XSITEMAP_FORMSUREDEL, $obj->getVar("plugin")));
        }
        break;
    ...
    case "default":
    default:
        $moduleAdmin->addItemButton(_AM_XSITEMAP_CREATE_PLUGIN, basename(__FILE__) . '?op=add_plugin', 'add');
        ...
        if ($numrows > 0) {
            ...
            foreach (array_keys($plugin_arr) as $i) {
                if (0 == $plugin_arr[$i]->getVar("topic_pid")) {
                    ...
                    if (1 == $online) {
                        echo "    <td class='txtcenter width5'><a href='./plugin.php?op=update_online_plugin&plugin_id=" . $plugin_arr[$i]->getVar("plugin_id") . "&plugin_online=0'><img src='" . \Xmf\Module\Admin::iconUrl('on.png', '16') . "' border='0' alt='" . _AM_XSITEMAP_ON . "' title='" . _AM_XSITEMAP_ON . ", " . sprintf(_AM_XSITEMAP_CLICK_TO, _AM_XSITEMAP_OFF) . "'></a></td>\n";
                    } else {
                        echo "    <td class='txtcenter width5'><a href='./plugin.php?op=update_online_plugin&plugin_id=" . $plugin_arr[$i]->getVar("plugin_id") . "&plugin_online=1'><img src='" . \Xmf\Module\Admin::iconUrl('off.png', '32') . "' border='0' alt='" . _AM_XSITEMAP_OFF . "' title='" . _AM_XSITEMAP_OFF . ", " . sprintf(_AM_XSITEMAP_CLICK_TO, _AM_XSITEMAP_ON) . "'></a></td>\n";
                    }
                    echo "    <td class='txtcenter'>" . $plugin_arr[$i]->getVar("plugin_name")        . "</td>\n"
                       ...
                       . "      <a href='plugin.php?op=edit_plugin&plugin_id=" . $plugin_arr[$i]->getVar("plugin_id") . "'><img src='" . \Xmf\Module\Admin::iconUrl('edit.png', '16') . "' alt='" . _EDIT . "' title='" . _EDIT . "'></a>\n"
                       . "      <a href='plugin.php?op=delete_plugin&plugin_id=" . $plugin_arr[$i]->getVar("plugin_id") . "'><img src='" . \Xmf\Module\Admin::iconUrl('delete.png', '16') . "' alt='" . _DELETE . "' title='" . _DELETE . "'></a>\n"
                       . "    </td>\n"
                       . "  </tr>\n";
                }
            }
