...
if (file_exists($xmlfile)) {
    ...
    echo "<div class='pad7 width80'>\n"
       ...
       . "<p style='margin-bottom: 2em;'>" . _AM_XSITEMAP_XML_LASTUPD . ":</p>\n"
       ...
       . "  <input id='viewbtn' type='button' value='" . _AM_XSITEMAP_XML_VIEW_XML . "' onclick='window.location.href =\"" . $GLOBALS['xoops']->url("www/xsitemap.xml") . "\"'>\n"
       . "  <input style='margin-left: 3em;' type='submit' name='update' value='" . _AM_XSITEMAP_MANAGER_UPDATE . "'>\n"
       . "</form>\n"
       . "<br>\n";
} else {
    echo "<div class='pad7'>\n"
